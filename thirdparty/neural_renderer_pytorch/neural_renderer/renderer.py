...
class Renderer(nn.Module):
    ...
    def forward(self, vertices, faces, textures=None, mode=None, K=None, R=None, t=None, dist_coeffs=None, orig_size=None):
        ...
        elif mode == 'fim_and_wim':
            return self.render_fim_wim(vertices, faces, K, R, t, dist_coeffs, orig_size)
        else:
    ...
    def render_fim_wim(self, vertices, faces,  K=None, R=None, t=None, dist_coeffs=None, orig_size=None):
        if self.camera_mode == 'projection':
            if K is None:
                K = self.K
            if R is None:
